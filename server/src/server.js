...
app.get("/api/health",(_,res)=>res.json({status:"ok",service:"WorkSphere API"}));
app.use("/api/auth",authRoutes);app.use("/api/projects",projectRoutes);app.use("/api/tasks",taskRoutes);app.use("/api/activity",activityRoutes);
